...
<meta charset="utf-8">
 ...
 <h1>Music Gallery</h1>
 <ul><li><a class="active" >Home</a></li>
 <li class="dropdown"><a  class="dropbtn">Genre<span class="caret"></span></a>
 ...
 ?>
 <p> Are you a Music Freak? <br> Love to keep a collection of all your favourite artists? <br> Find all the albums of your favourite artist at our store! <br> And Good News! <br> Merchandise Coming SOON! <h2> CLICK and ORDER.</h2></p><div><div class="clearfix"></div>
 </div></body></html>